 ...
 * 
 */
@WebServiceClient(name = "PersonServiceImplService", targetNamespace = "http://impl.service.server.example.com/", wsdlLocation = "http://localhost:8888/ws/person?wsdl")
    ...
    extends Service
{
    ...
    private final static QName PERSONSERVICEIMPLSERVICE_QNAME = new QName("http://impl.service.server.example.com/", "PersonServiceImplService");
    ...
    public PersonService getPersonServiceImplPort() {
        return super.getPort(new QName("http://impl.service.server.example.com/", "PersonServiceImplPort"), PersonService.class);
    }
    ...
    public PersonService getPersonServiceImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://impl.service.server.example.com/", "PersonServiceImplPort"), PersonService.class, features);
    }
